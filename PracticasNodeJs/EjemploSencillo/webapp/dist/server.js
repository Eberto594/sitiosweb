...
expressApp.post("/", readHandler_1.readHandler);
expressApp.post("/add", readHandler_1.addHandler);
expressApp.post("/editar/:id", readHandler_1.editHandler);
expressApp.post("/borrar/:id", readHandler_1.deleteHandler);
