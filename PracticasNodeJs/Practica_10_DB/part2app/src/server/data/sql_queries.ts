// métodos que brindan acceso a la base de datos
// comenzando con aquellos que consultan datos.
...
// Estas consultas utilizan parámetros nombrados, que se indican con un signo $ y 
// permiten que se proporcionen valores cuando se ejecuta la consulta.
...
// Las instrucciones insertPerson e insertCalculation insertarán nuevas 
// filas en las tablas People y Calculation solo si no hay filas existentes 
// que tengan los mismos detalles.
